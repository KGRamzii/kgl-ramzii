<div>
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        <div class="md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Edit Client</h3>
        ...
        <div class="mt-10 md:grid md:grid-cols-3 md:gap-6">
            <div class="md:col-span-1">
                <div class="px-4 sm:px-0">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Client Services</h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Manage services provided to this client and their custom pricing.
                    </p>
                </div>
            </div>
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <div class="shadow sm:rounded-md sm:overflow-hidden">
                    <div class="px-4 py-5 bg-white dark:bg-gray-800 sm:p-6">
                        <livewire:client-services.manage :client="$client" />
                    </div>
                </div>
            </div>
        </div>
